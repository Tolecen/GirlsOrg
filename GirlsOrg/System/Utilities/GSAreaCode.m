...
//  GirlsOrg
//
//  Created by Tolecen on 14/12/25.
//  Copyright (c) 2014年 uzero. All rights reserved.
//

#import "GSAreaCode.h"

@implementation GSAreaCode
+(NSDictionary *)setTheLocalAreaCode
{
    ...
    NSDictionary * dict = [NSDictionary dictionaryWithObjectsAndKeys:defaultCode,@"countryCode",defaultCountryName,@"countryName", nil];
    return dict;
}
