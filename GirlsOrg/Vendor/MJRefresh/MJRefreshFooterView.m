...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.pullToRefreshText = CommonLocalizedStrings(@"footerpullToRefresh");
        self.releaseToRefreshText = CommonLocalizedStrings(@"footerreleaseToRefresh");
        self.refreshingText = CommonLocalizedStrings(@"footerRefresh_title");
    }
    return self;
}
